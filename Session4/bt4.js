...
for ( i = 0 ; i < products.length ; i++){
 ...
 //  5.3
let userInput1 = prompt(" Enter your category")
for ( i = 0 ; i < products.length ; i++){
        if( userInput1 == products[i].category ){
            console.log("----------------");
            console.log(`Name : ${products[i].name}`)
            console.log(`Price : ${products[i].price}`)
        }
...
// 5.5
let providersInput = prompt(" Enter providers")
for ( i = 0 ; i < products.length ; i++){
...
function print(arr) {
    ...
    for (let i = 0; i < arr.length; i++) {
      console.log(`${i + 1}. ${arr[i].developer}`);
...
let Dev = [
    ...
    {
      developer: "Basis of JavaScript",
      complete: false,
    },
    {
      developer: "Node Package Manager (npm)",
      complete: false,
    },
    {
      developer: "Git",
...
let userInput = prompt("Enter your command (new,delete,update,complete) ").toLowerCase

if(userInput == "new"){
    let newDeveloper = prompt("Nhập tên mới")
    Dev.push({
...
print(Dev)
   ...
   let postion = prompt(" Enter postion :")
   let newDeveloper = prompt('Enter new title');
   Dev[position - 1].developer = newTitle;
   print(Dev);
}else if (userInput == "complete"){
    let newComplete = prompt(" Enter postion :")
    Dev[newComplete - 1].complete = true;
    print(Dev)
}else if (userInput == "delete"){
    let newDelete = prompt(" Enter postion delete :")
    Dev.splice(newDelete - 1 , 1)
    print(Dev)    
}else{
    console.log("Not found")
}
...
console.log(jobData.hit)

// 15.2
console.log(jobData.hit[0]);

// 15.3
console.log(jobData.hit[0].jobTitle)

// 15.4
console.log(jobData.hit[0].benefits)

// 15.5
console.log(`Fist job hit benefit :`)
for(i =  0 ; i < jobData.hit[0].benefits.length ; i++){
    console.log(` - ${jobData.hit[0].benefits[i].benefitValue}`)
}

// 15.6
for(i = 0 ; i < jobData.hit.length  ; i++){
        console.log("--------------------")
        console.log(jobData.hit[i].jobTitle)
        console.log("Benefits:")
  for (j = 0 ; j < jobData.hit[i].length ; j++){
    console.log(` - ${jobData.hit[0].benefits[j].benefitValue}`)
}
}  

// 15.7
for(i = 2; i < jobData.hit.length  ; i++){
    console.log(`Titler : ${jobData.hit[i].jobTitle}`)
    console.log(`Salary : ${jobData.hit[i].jobSalary}`)
    console.log(`Locations : ${jobData.hit[i].locations}`)
    for (j = 0 ; j < jobData.hit[i].length ; j++){
    console.log(`Benefits : ${benefits[j].benefitValue}`)
    }
    console.log(`Skills : ${ "-" + jobData.hit[i].skills}`)
    console.log("--------------------")
}
